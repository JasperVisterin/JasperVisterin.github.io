...
excerpt: "The results improve the current state of analysis and control concerning time-delay systems. Beyond refining existing tools, this work introduces a novel distributed-delay output feedback control law, including regularization."
